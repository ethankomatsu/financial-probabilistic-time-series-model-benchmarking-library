...
from finprobts.models.quantileformer import QuantileFormerForecastModel
...
class ModelRegistry:
    ...
    def create(self, name: str, **kwargs: Any) -> BaseProbForecastModel:
        ...
        try:
            return self._factories[normalized_name](**kwargs)
...
def get_default_model_registry() -> ModelRegistry:
    ...
    registry.register("quantileformer", QuantileFormerForecastModel)
